...
class GripBallContour:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [3.237410071942446, 21.576960589531488]
        self.__hsv_threshold_saturation = [117.78414083154101, 255.0]
        self.__hsv_threshold_value = [98.8016363425653, 255.0]
